...
- Support Android-first mobile scanning with weak or intermittent connectivity.
...
- Teachers scan using Android smartphones first. iOS support may follow.
...
The mobile app should perform lightweight checks before upload:
...
| Browser/mobile cache | Assessment metadata, user preferences, offline scan state |
